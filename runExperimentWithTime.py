    ...
    for intervention in range(numI):
        ...
        for penultimateIndex in range(numPenultimate):
            ...
            if (isPenultimateNotIntervened):
                LeafInterventionChosen = np.random.choice(np.arange(4), p=[prob0Leaf ** 2, prob0Leaf * prob1Leaf,
                                                                           prob0Leaf * prob1Leaf, prob1Leaf ** 2])
...
if __name__ == "__main__":
    ...
    numSamplesToChoose = [500, 1000, 2000,3000,4000, 5000, 10000, 15000, 20000, 25000]
    ...
    methodsTuple = [(getDirectExpRegret, 1000), (getYabeRegret, 1000), (getCIRegret, 100)]
    methodsTuple = [(getDirectExpRegret, 1000), (getYabeRegret, 1000), (getCIRegret, 100)]
    ...
    for i in range(len(numSamplesToChoose)):
        ...
        for j in range(len(methodsTuple)):
            ...
            numExperimentsToAvgOver = methodTuple[1]
    ...
    filePathToSave = 'outputs/regretWithTime_' + str(round(pi, 2)) + 'pi' + str(epsilon) + 'eps' + \
                     str(degree) + 'degree' + ''.join(colNames) + date_time + '.csv'
